...
let elem = document.getElementsByClassName('zA yO');
elem.style.background = 'green';



let elem = document.getElementById(':3b');
elem.style.background = 'green';
...
let elem = document.querySelector('zA yO');
elem.style.background = 'red';
...
let pin = document.getElementsByClassName('zA yO');
